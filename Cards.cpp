...
struct Ability {
	...
	string P1VPF2 = "+1 VP per Fyling card";
...
void Deck::generateDeck()
{
	...
	cards[10] = Card(gd.TOWER, ctype.SINGLE, act.BUILD, abt.P1VPF2);
	...
	cards[16] = Card(gd.LAKE, ctype.OR, act.ADD2, act.MOVE3, abt.P1VPF2);
